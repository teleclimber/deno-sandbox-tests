...
class DummyRemoteServer {
	...
	async checkHits(test_num) {
		await delay(300);
		// const ret = {};
		// const hits = this.test_hits[test_num];
		// for( let k in this.test_resps[test_num] ) {
		// 	const r = this.test_resps[test_num][k];
		// 	if( r.no_hit && this.test_hits[] ) ret[k] = r;
		// }
		// return ret;
